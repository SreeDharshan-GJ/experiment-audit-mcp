...
from experiment_audit_mcp.reasoning.confidence import ConfidenceAssessor
from experiment_audit_mcp.reasoning.engine import ScientificReasoningEngine
...
class _NullJudgmentGenerator:
    def generate(self, rule_findings: Sequence[Any], confidence: Any) -> Sequence[Any]:
        del rule_findings, confidence
        return ()
