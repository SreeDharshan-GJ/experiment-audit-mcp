...
from experiment_audit_mcp.reasoning.evidence import Evidence, EvidenceItem, EvidenceKind
from experiment_audit_mcp.reasoning.hypotheses import Hypothesis, HypothesisSet
...
if TYPE_CHECKING:
    ...
    from experiment_audit_mcp.reasoning.claims import Claim, ClaimSet, Scope
    from experiment_audit_mcp.reasoning.confidence import ConfidenceSet
    ...
    from experiment_audit_mcp.reasoning.evidence import MissingEvidenceRecord
    from experiment_audit_mcp.reasoning.judgment import JudgmentSet
